...
class PlatformHelper:
    ...
    @staticmethod
    def get_platform_context_string() -> str:
        """
        Get formatted platform context string for agent backstories.

        Returns:
            Multi-line string with platform, user, and directory information.
        """
